...
static const variant_info_t aether_info = {
    ...
    .model = "22126RN91Y",
    .build_fingerprint = "Redmi/aether_global/aether:14/UP1A.231005.007/V816.0.16.0.UCVMIXM:user/release-keys"
};
...
static const variant_info_t earth_p_info = {
    ...
    .marketname = "POCO C55",
    .model = "22127PC95G",
    .build_fingerprint = "POCO/earth_p_global/earth:14/UP1A.231005.007/V816.0.16.0.UCVMIXM:user/release-keys"
};
